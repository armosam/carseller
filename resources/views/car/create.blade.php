    ...
    <main>
        <div class="container-small">
            ...
            >
                ...
                {{--@dump($errors)
                @dump($errors->get('state_id'))
                @dump($errors->has('state_id'))

                @error('city_id')
                    There are some error with city id
                @enderror--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group @error('vin') has-error @enderror">
                                    ...
                                    <input type="text" name="vin" value="{{old('vin')}}" placeholder="VIN Number" />
                            ...
                            <div class="col">
                                <div class="form-group @error('mileage') has-error @enderror">
                                    <label>Mileage</label>
                                    <input type="number" name="mileage" value="{{old('mileage')}}" placeholder="Mileage" />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group @error('interior_color') has-error @enderror">
                                    ...
                                    <input type="tel" name="interior_color" value="{{old('interior_color')}}" placeholder="Interior Color" />
                            ...
                            <div class="col">
                                <div class="form-group @error('exterior_color') has-error @enderror">
                                    ...
                                    <input type="tel" name="exterior_color" value="{{old('exterior_color')}}" placeholder="Exterior Color" />
