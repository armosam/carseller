                                    ...
                                    <td class="">
                                        ...
                                        @can('delete', $car)
                                            <form action="{{ route('car.destroy', $car) }}" method="POST" class="inline-flex">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-delete inline-flex items-center" onclick="return confirm('Are you sure to delete this car?')">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center p-large">
                                        You do not have any cars yet. <a href="{{ route('car.create') }}">Create now</a>
                                    </td>
                                </tr>
                            @endforelse
