            ...
            <div class="container">
                <div class="sm:flex items-center justify-between mb-medium">
                    ...
                    <select class="sort-dropdown">
                        ...
                        <option value="published_at">Newast At The Top</option>
                                ...
                                <div class="find-a-car-inputs">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="flex gap-1">
                                            <input type="number" value="{{request('year_from')}}" placeholder="Year From" name="year_from" />
                                            <input type="number" value="{{request('year_to')}}" placeholder="Year To" name="year_to" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-medium">Price</label>
                                        <div class="flex gap-1">
                                            <input type="number" value="{{request('price_from')}}" placeholder="Price From" name="price_from" />
                                            <input type="number" value="{{request('price_from')}}" placeholder="Price To" name="price_to" />
                                        </div>
                                    </div>
                                    <div class="form-group">
